...
<body>
    ...
    <footer class="bg-dark pt-[94px] relative">
        ...
        <div class="mx-auto container flex items-center justify-between gap-5 pb-8">
          ...
          <p class="text-sm  text-center text-[#E5E5E580] leading-5 z-50 relative"> Developed by <a href="#" target="_blank" class="hover:underline font-medium">Sajedul Islam⚡️</a></p>
          <span></span>
        </div>
    </footer>
